...
class AlcoholsControllerTest < ActionController::TestCase
  ...
  test "should create alcohol" do
    assert_difference('Alcohol.count') do
      post :create, alcohol: { decsription: @alcohol.decsription, ingredients: @alcohol.ingredients, name: @alcohol.name }
    end
  ...
  test "should update alcohol" do
    patch :update, id: @alcohol, alcohol: { decsription: @alcohol.decsription, ingredients: @alcohol.ingredients, name: @alcohol.name }
    assert_redirected_to alcohol_path(assigns(:alcohol))
  end
